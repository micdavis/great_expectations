    ...
    def __init__(
        ...
        Args:
            ...
            cardinality_limit_mode: CardinalityLimitMode or string name of the mode
                ...
                filtering columns.
                Accessible for convenience via DataProfilerDomainBuilder.cardinality_limit_modes e.g.:
                cardinality_limit_mode=DataProfilerDomainBuilder.cardinality_limit_modes.VERY_FEW,
